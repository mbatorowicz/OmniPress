...
export function buildNavTreeSectionData(input: NavTreeSectionProps): NavTreeSectionData {
	...
	const navTableLabels: NavigationTableLabels = {
		...
		linkHintNone: adminLayout.fields.navLinkHintNone,
		linkHintWithTarget: adminLayout.fields.navLinkHintWithTarget,
		fieldLabels: {
			...
			navSectionPosition: adminLayout.fields.navSectionPosition,
			navSectionLink: adminLayout.fields.navSectionLink,
			navSectionDropdown: adminLayout.fields.navSectionDropdown,
