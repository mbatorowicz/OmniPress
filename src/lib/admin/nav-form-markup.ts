	...
	return `
		<div class="nav-row-editor-panel">
			<section class="nav-row-editor-section">
				<h3 class="nav-row-editor-section-title">${fieldLabels.navSectionPosition}</h3>
			...
			<section class="nav-row-editor-section">
				<h3 class="nav-row-editor-section-title">${fieldLabels.navSectionLink}</h3>
				<div class="nav-row-editor-grid">
					<label class="nav-row-editor-field">
					...
					<label class="nav-row-editor-field nav-row-editor-field--wide nav-link-target-field hidden">
				...
				<p class="ui-hint nav-link-hint mt-1 text-[10px] leading-tight" data-hint-none="${labels.linkHintNone}" data-hint-target="${labels.linkHintWithTarget}">${labels.linkHintNone}</p>
			</section>
			<section class="nav-row-editor-section nav-dropdown-layout-field-wrap">
				<h3 class="nav-row-editor-section-title">${fieldLabels.navSectionDropdown}</h3>
