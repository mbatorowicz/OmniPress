...
**Administrator** — jednostki, redaktorzy, akceptacja, import z GitHub, layout, dezaktywacja/usuwanie na stronie. Po *Wyślij do akceptacji* dostaje sygnał na Telegram (gdy bot jest skonfigurowany) z przyciskiem *Akceptuj* i widzi liczbę oczekujących w panelu. Mail na skrzynkę inbound zakłada szkic — publikacja nadal wymaga akceptacji.
