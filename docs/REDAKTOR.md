...
| Treść artykułu | Edytor z pogrubieniem, kursywą, nagłówkami, listami i linkami. Enter = nowy akapit; wklejony tekst z Worda skleja się w zwykłe akapity (tak samo w podglądzie i na stronie). Zdjęcia i PDF dodaj poniżej, nie wklejaj ich w tekst. Emoji (kalendarzyk, pinezka, serduszko) są usuwane z treści — strona ma wygląd urzędowy. |
...
| Sekcja | Zasady |
|--------|--------|
| Galeria zdjęć | Pierwsze zdjęcie = zajawka na liście wpisów. Kolejność strzałkami, usuwanie krzyżykiem. JPEG, PNG, WebP, GIF — max **10 MB**. Nowe zdjęcia (poza GIF) zmniejszamy do 1920 px i zapisujemy jako WebP. |
...
|--------|------------------|
| Szkic | Poprawiać, zapisywać, wysłać albo usunąć. Przy pilnym komunikacie administrator może wysłać szkic do akceptacji albo opublikować go za Ciebie |
...
- **Szkic, którego nie wysłałeś** — administrator widzi go na swojej liście i w pilnej sprawie (albo gdy jesteś nieobecny) może wysłać go do akceptacji lub opublikować za Ciebie. Wtedy edycja zostaje zablokowana tak samo jak po Twoim wysłaniu. Jeśli wpis nie jest gotowy, trzymaj w nim tylko tyle treści, ile chcesz pokazać.
