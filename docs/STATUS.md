...
**Następna sesja:** walidacja menu bez self-check (P0-9) i a11y hamburgera (P1-18) — plan w [AUDYT-WYKONANIE.md](./AUDYT-WYKONANIE.md#następna-sesja--walidacja-menu--a11y-po-15). Podejście 15 (menu bez 404) zamknięte 2026-09-03.
...
|---------|-----------|--------|
| Jednostkowe (`npm test`) | Vitest | logika `lib/` — 105 plików testowych obok modułów (761 testy + 22 RLS opt-in) |
