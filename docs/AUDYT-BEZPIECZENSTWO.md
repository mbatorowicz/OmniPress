...
**Następna sesja:** S-1–S-4 zamknięte. Podejścia 22–24 zamknięte. Następne otwarte: [AUDYT-WYKONANIE.md](./AUDYT-WYKONANIE.md) **25**.
...
Agent czyta **ten plik** (nie canvas). Bierze pierwsze S-* bez ✅. S-1–S-4 są zamknięte — następne otwarte to [AUDYT-WYKONANIE.md](./AUDYT-WYKONANIE.md) **25**, o ile użytkownik nie poda innego scope.
