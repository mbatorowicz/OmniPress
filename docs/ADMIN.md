...
1. Temat i treść maila to punkt startowy. Grok **ogląda** załączniki (obraz, skan PDF jako obraz strony, grafiki z Worda) — tytuł ma nazywać sprawę z materiału, nie temat „Plakaty”. Daty i nazwę gminy przepisuje z plakatu; przy niepewnym celu podmiany pyta, zamiast zgadywać. Jeden mail = **jeden** szkic, chyba że na obrazach widać osobne materiały (inny kolor, inny klimat grafiki). Plakaty o tym samym wyglądzie, tylko kolejna strona albo wariant, zostają w **jednym** szkicu. Gdy Grok mimo to sklei dwa komunikaty, kod je rozdziela. Pismo przewodnie poza wpisem. Plakat / ulotka / zdjęcie idzie jako **podgląd**; uchwała — jako link. Z DOCX **bez pieczątki i podpisu** grafiki idą do galerii (pierwsza = zajawka), a plik Word nie zostaje przy wpisie.
