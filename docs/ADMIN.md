...
1. Temat i treść maila to punkt startowy. Grok **ogląda** załączniki (obraz, skan PDF jako obraz strony, grafiki z Worda) i **redaguje jeden szkic** — tytuł z materiału, nie temat „Plakaty”. Daty i nazwę gminy przepisuje z plakatu. **Jeden mail = jeden wpis**; kolejne sprawy idą osobnymi mailami. Pismo przewodnie poza wpisem. Plakat / ulotka / zdjęcie idzie jako **podgląd**; uchwała — jako link. Z DOCX **bez pieczątki i podpisu** grafiki idą do galerii (pierwsza = zajawka), a plik Word nie zostaje przy wpisie.
